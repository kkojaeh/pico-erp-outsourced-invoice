...
@Entity(name = "OutsourcedInvoiceItem")
@Table(name = "OSDI_OUTSOURCED_INVOICE_ITEM", indexes = @Index(columnList = "INVOICE_ID"))
@Data
...
@NoArgsConstructor
@Builder
public class OutsourcedInvoiceItemEntity implements Serializable {
